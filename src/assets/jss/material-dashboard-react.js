...
const warningColor = ['#FF9800', '#FF9800', '#FF9800', '#FF9800'];
const dangerColor = ['#FF9800', '#FF9800', '#FF9800', '#FF9800'];
const successColor = ['#4caf50', '#66bb6a', '#43a047', '#5cb860'];
const infoColor = ['#FF9800', '#FF9800', '#FF9800', '#FF9800'];
const roseColor = ['#FF9800', '#FF9800', '#FF9800', '#FF9800'];
const grayColor = [
  '#999',
  '#777',
  '#3C4858',
