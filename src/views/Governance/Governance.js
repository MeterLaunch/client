    ...
    <GridContainer justifyContent="center">
      <GridItem xs={12} sm={12} md={8}>
        <Card>
          ...
          {transactiveflag && (
            <CardFooter>
              <Button disabled={approve_flag} onClick={(e) => approveToken()} color="primary">
                Approve
              </Button>
              <Button disabled={lock_flag} onClick={(e) => locktoken()} color="primary">
                Lock
              </Button>
              <Button disabled={unlock_flag} onClick={(e) => withdraw()} color="primary">
                unLock
              </Button>
            </CardFooter>
          )}
      ...
      <GridItem xs={12} sm={6} md={3}>
        <Card>
          ...
          <CardBody>
            ...
            <Danger>{price} coin</Danger>
            <br />
            <Info>
              <small>PFee:</small>
            </Info>
            <Danger>{penalfee}</Danger>
            <br />
            <Info>
              <small>Unlock time:</small>
            </Info>
            <Danger>{unlocktime}</Danger>
          </CardBody>
          {/* <CardFooter stats>
