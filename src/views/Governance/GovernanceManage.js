        ...
        <Card>
          ...
          <CardFooter>
            <div className={classes.stats}>
              ...
              <Danger>Only contract owner can do it.</Danger>
            </div>
            <Button variant="outlined" onClick={(e) => changeowner()} color="info">
              Change
            </Button>
          </CardFooter>
        </Card>
      ...
      <GridItem xs={12} sm={6} md={5}>
        <Card>
          ...
          <CardBody>
            ...
            <Info>
              <small>Saved balance:</small>
            </Info>
            <Primary>
              <h4>{contractbalance}</h4>
            </Primary>
          </CardBody>
          <CardFooter>
            <div className={classes.stats}>
            ...
            <Button variant="outlined" onClick={(e) => wintdraw()} color="warning">
              Withdraw
            </Button>
          </CardFooter>
        </Card>
      ...
      <GridItem xs={12} sm={6} md={5}>
        <Card>
          ...
          <CardFooter>
            ...
            <Button variant="outlined" onClick={(e) => SetPrice()} color="warning">
              Set Price
            </Button>
          </CardFooter>
        </Card>
      ...
      <GridItem xs={12} sm={6} md={5}>
        <Card>
          ...
          <CardFooter>
            ...
            <Button variant="outlined" onClick={(e) => SetFee()} color="warning">
              Set Fee
            </Button>
          </CardFooter>
        </Card>
