...
export default function FeeInfo(props) {
  ...
  return (
    <Card>
      ...
      <CardBody>
        <Info>Normal Fee:</Info>
        <Danger>{fee.normal}</Danger>
        <Info>Mint Fee:</Info>
        <Danger>{fee.mint}</Danger>
        <Info>Burn Fee:</Info>
        <Danger>{fee.burn}</Danger>
        <Info>Pause Fee:</Info>
        <Danger>{fee.pause}</Danger>
        <Info>Blacklist Fee:</Info>
        <Danger>{fee.blacklist}</Danger>
        <Info>Reflection Fee:</Info>
        <Danger>{fee.deflation}</Danger>
        <p />
        <Divider textAlign="center"></Divider>
        <p />
        <Primary>Current Fee:</Primary>
        <Danger>{fee.curfee}</Danger>
      </CardBody>
    </Card>
  );
}
